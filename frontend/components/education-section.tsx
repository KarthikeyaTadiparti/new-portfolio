...
export function EducationSection() {
  ...
  return (
    <section id="education" className="py-20 px-6 max-w-7xl mx-auto w-full border-b border-border bg-background relative font-mono scroll-mt-32 md:scroll-mt-4 lg:scroll-mt-8">
